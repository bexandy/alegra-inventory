Ext.define('Alegra.view.alegra.ProductBx', {
    extend: 'Ext.panel.Panel',
    xtype: 'alegra-product-bx',

    requires: [
        'Alegra.view.alegra.ProductBxController',
        'Alegra.view.alegra.ProductBxModel'
    ],
    ...
    viewModel: {
        type: 'alegra.productbx'
    },

    controller: 'alegra.productbx',
